...
Remember to use line-breaks between different elements using markdown syntax. Specially between bullet points, code blocks, equation , column sections and notes.
